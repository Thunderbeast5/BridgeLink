        ...
        <div className="bg-white/5 backdrop-blur-lg border border-gray-400/20 rounded-2xl p-8 shadow-2xl hover:bg-white/10 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAlumni.map((alumnus) => (
              <div key={alumnus.uid} className="bg-white/3 backdrop-blur-xl border border-gray-400/25 rounded-3xl p-10 shadow-2xl hover:bg-white/8 transition-all duration-300 rounded-lg p-6 hover:bg-slate-600 transition-colors">
